...
module.exports = function(/* environment */) {
  return {
    ...
    requiresTranslation(/* key, locale */) {
      // Only send missing translations warnings to the Embercom build output
      // if the opt-in environment variable is present
      return process.env.EMIT_EMBER_INTL_WARNINGS;
    },
  };
};
